  ...
  try {
    ...
    const instructions = {
      ...
      pages: [
        ...
        整个实验中您会看到两两一组，共大约80组的英语单词，而您需要稍作思考，评价每对词语语义的相似度。`,

        /*html*/ `<p class="text-left">下面有两组词语作为例子:<br><br><b>wise</b> vs <b>eye</b>. 他们有多么相似呢?<br><br>
        <b>kitchen</b> vs <b>stern</b>. 这组比较是否合适呢？.<br><br>
        虽然上面两组比较可能不算常见，但也许，相对于"kitchen"和"stern"，您感到"wise"和"eye"更加相近。请留意同一组的两个词不一定属于同一词类，如"wise"属于形容词，"eye"属于名词，所以<b>请不要把是否属于同一类词作为判断标准</b>。 <br><br>
