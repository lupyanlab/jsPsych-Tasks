...
jsPsych.plugins['lupyanlab-typicality-image-rate'] = (function() {
  var plugin = {};

  jsPsych.pluginAPI.registerPreload('lupyanlab-typicality-image-rate', 'image', 'image');

  plugin.info = {
    name: 'lupyanlab-typicality-image-rate',
    parameters: {
      trial_progress_text: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    const end_trial = (selected_key) => {
      ...
      const selected_label = trial.labels[trial.keys.indexOf((key) => key === selected_key)];
