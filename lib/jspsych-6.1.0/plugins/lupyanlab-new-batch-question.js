/**
 * Ported from jspsych-html-button-response
 **/

jsPsych.plugins['lupyanlab-new-batch-question'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'lupyanlab-new-batch-question',
    description: '',
    parameters: {
      stimulus: {
      ...
      on_response: {
        ...
        pretty_name: 'On response callback',
        default: null,
        description:
          'Called after making a response. Passes the data (same as on_finish). It should be a promise or async function.',
      },
    },
  };
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function end_trial() {
      ...
      trial.on_response(trial_data).then(() => {
