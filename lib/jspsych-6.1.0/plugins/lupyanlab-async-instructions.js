...
jsPsych.plugins['lupyanlab-async-instructions'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'lupyanlab-async-instructions',
    description: '',
    parameters: {
      pages: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    async function show_current_page() {
      var html = await trial.pages[current_page]();
