    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      if (keys[i] !== 'type') {
        ...
        if (
          ...
          (typeof jsPsych.plugins[trial.type].info.parameters[keys[i]] !== 'undefined' &&
          ...
          for (var i in trial[param]) {
            ...
            for (var p in jsPsych.plugins[trial.type].info.parameters[param].nested) {
              if (typeof trial[param][i][p] == 'undefined' || trial[param][i][p] === null) {
                if (
                  typeof jsPsych.plugins[trial.type].info.parameters[param].nested[p].default ==
                  'undefined'
                ) {
                  console.error(
                  ...
                  trial[param][i][p] =
                    jsPsych.plugins[trial.type].info.parameters[param].nested[p].default;
                }
              }
            }
          }
  ...
  module.autoPreload = function(timeline, callback, images, audio, video, progress_bar) {
    ...
    function update_loading_progress_bar() {
      ...
      if (progress_bar) {
        ...
        jsPsych.getDisplayElement().querySelector('#jspsych-loading-progress-bar').style.width =
          percent_loaded + '%';
      }
    }
